...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int]):
        # Salva o placar do jogador no banco de dados
    ...
    def show(self):
        ...
        while True:
            ...
            for i, player_score in enumerate(list_score):
                ...
                self.score_text(20, f'{name}     {score:05d}     {date}', C_YELLOW, SCORE_POS[i])
...
def get_formatted_date():
    ...
    return f"{current_datetime.strftime('%H:%M')} - {current_datetime.strftime('%d/%m/%y')}"